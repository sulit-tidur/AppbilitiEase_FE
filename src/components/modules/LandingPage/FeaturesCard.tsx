...
const FeaturesCard = () => {
  return (
    <div className={`${roboto.className} bg-dark w-[95%] self-center p-10 rounded-[14px] flex flex-col md:flex-row justify-center place-content-center gap-10 xl:gap-6`}>
      {/* Cari Fasilitas */}
      <div className="flex flex-col sm:flex-row md:flex-col xl:flex-row items-center gap-4 group">
        <Image
          src={'/images/cari-fasilitas-icon.svg'}
          width={101} height={101} alt="Cari Fasilitas"
          className="group-hover:-translate-y-1 transition"
        />
        <div className="flex flex-col gap-2 items-center sm:items-start md:items-center xl:items-start">
          <p className="text-white font-medium text-lg">
            Cari Fasilitas Terdekat
          </p>
          <p className="text-white/70 text-xs text-center sm:text-left md:text-center xl:text-left">
